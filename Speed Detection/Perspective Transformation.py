...
# Define the target rectangle's corner points
TARGET = np.array([
    [0, 0],
    [TARGET_WIDTH - 1, 0],
...
if __name__ == "__main__":
    ...
    for frame in frame_generator:
        ...
        # Generate labels for the transformed points
        labels = [
            f"x: {x}, y: {y}"  # Display transformed coordinates
            for [x, y] in points
        ]
        ...
        # Annotate the frame with labels (transformed coordinates)
